...
const Main = () => {
        ...
        { field: "user_status", headerName: "Status", flex: 1 },
        {
            ...
            renderCell: (params: any) => (
                <div className='w-full flex justify-center items-center px-2 h-fit'>
                    ...
                    <div className='flex justify-start items-center gap-[4px] cursor-pointer h-fit'
                        onClick={() => view_sub_admin(params?.row?.user_id)}
                    >
    ...
    const delete_sub_admin_confirmation = (userId: string) => {
        if (!userId) return
        set_alert_data({
            title: "Delete Sub Admin?",
            description: "Are you sure you want to delete this sub admin?. The action cannot be undone",
        ...
        <>
            ...
            <div className="flex flex-col justify-start items-start gap-4 mt-4 flex-1 overflow-x-auto">
                <div className="w-full flex justify-between items-center">
                    <Typography variant="h5" component="h3">Sub Admins</Typography>
