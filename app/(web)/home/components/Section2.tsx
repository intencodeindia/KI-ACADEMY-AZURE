...
const Section2 = () => {
    ...
    const [firstCards, set_firstCards] = useState<any>([]);
    ...
    return (
        <>
            <div className="section-2">
                ...
                <div className="cards-cont hide-scrollbar" ref={containerRef}>
                    {cardOptions?.map((option: any) => <Card key={option?.id} title={option?.title} text={option?.text} image={option?.image} course_id={option?.course_id} />)}
                </div>
